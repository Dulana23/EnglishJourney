...
<head>
     <title>Help & Contact | EnglishJounery</title>
    <meta charset="utf-8">
        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase text-warning mb-4">EnglishJourney.lk</h5>
                    <p>Here we are the EnglishJourney.lk&trade; to support you for accomplish your dessire by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy; 2026 EnglishJourney All Rights Reserved.</p>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-at"></i> englishjourney@gmail.com</p>
