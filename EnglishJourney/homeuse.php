<html>
    ...
    <title>Home Usage | Vocabluary | EnglishJounery</title>
        ...
        <div class="row justify-content-center mb-5">
            <div class="con col-md-4 bg-light p-4 rounded shadow-sm border">
                <ul class="list-unstyled fs-5">
                    <li>  What do you do when you at home ?</li>
                    <li> How to speak with others?</li>
        ...
        <div class="col-12 col-md-10 col-lg-8">
            <div class="list-group shadow-sm">
                ...
                <div class="sen3 col-11 col-md-auto" 
                     onmouseover="speakText(this)" style="cursor: pointer;">
                    <span class="fs-5"> I <b> wash</b> my face.</span>
                </div>
