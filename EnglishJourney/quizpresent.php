...
<head>
    ...
    <title>Game | Simple Present Tense | EnglishJourney</title>
...
<div class="container-fluid">
    ...
    <div class="quiz-container">
        <div class="sticky-top-custom">
            <h2 class="text-center text-white  mb-3">Simple Present Tense Quiz</h2>
            <div class="progress">
        ...
        <div id="quiz-content" class="mt-4">
            <div class="question-card" id="q1">
                <p class="question-text">[Q1] I <span class="quiz-slot" data-ans="go">_____</span> to school every day.</p>
            ...
            <div class="question-card" id="q2">
                <p class="question-text">[Q2] We <span class="quiz-slot" data-ans="study">_____</span> English in the morning.</p>
                <div class="options-grid">
            ...
            <div class="question-card" id="q3">
                <p class="question-text">[Q3] I <span class="quiz-slot" data-ans="play">_____</span> football after school.</p>
                <div class="options-grid">
                    <div class="btn-option" onclick="check(this, 'play', 'q3')">play</div>
                    <div class="btn-option" onclick="check(this, 'plays', 'q3')">plays</div>
                    <div class="btn-option" onclick="check(this, 'playing', 'q3')">playing</div>
                </div>
            </div>

            <div class="question-card" id="q4">
                <p class="question-text">[Q4] They <span class="quiz-slot" data-ans="watch">_____</span> TV in the evening.</p>
                <div class="options-grid">
                    ...
                    <div class="btn-option" onclick="check(this, 'watch', 'q4')">watch</div>
                </div>
            </div>

            <div class="question-card" id="q5">
                <p class="question-text">[Q5] My mother <span class="quiz-slot" data-ans="cooks">_____</span> dinner at night.</p>
                <div class="options-grid">
            ...
            <div class="question-card" id="q6">
                <p class="question-text">[Q6] I <span class="quiz-slot" data-ans="get">_____</span> up early every day.</p>
                <div class="options-grid">
            ...
            <div class="question-card" id="q7">
                <p class="question-text">[Q7] She <span class="quiz-slot" data-ans="brushes">_____</span> her teeth every morning.</p>
                <div class="options-grid">
                    <div class="btn-option" onclick="check(this, 'brushes', 'q7')">brushes</div>
                    <div class="btn-option" onclick="check(this, 'brush', 'q7')">brush</div>
                    <div class="btn-option" onclick="check(this, 'brushing', 'q7')">brushing</div>
                </div>
            </div>

            <div class="question-card" id="q8">
                <p class="question-text">[Q8] We <span class="quiz-slot" data-ans="listen">_____</span> to music on weekends.</p>
                <div class="options-grid">
                    ...
                    <div class="btn-option" onclick="check(this, 'listen', 'q8')">listen</div>
                </div>
            </div>

            <div class="question-card" id="q9">
                <p class="question-text">[Q9] The sun <span class="quiz-slot" data-ans="rises">_____</span> in the east.</p>
                <div class="options-grid">
                    <div class="btn-option" onclick="check(this, 'rises', 'q9')">rises</div>
                    <div class="btn-option" onclick="check(this, 'rise', 'q9')">rise</div>
                    <div class="btn-option" onclick="check(this, 'rising', 'q9')">rising</div>
                </div>
            </div>

            <div class="question-card" id="q10">
                <p class="question-text">[Q10] He <span class="quiz-slot" data-ans="does">_____</span> his homework after school.</p>
                <div class="options-grid">
                    <div class="btn-option" onclick="check(this, 'does', 'q10')">does</div>
                    <div class="btn-option" onclick="check(this, 'do', 'q10')">do</div>
                    <div class="btn-option" onclick="check(this, 'done', 'q10')">done</div>
                </div>
            </div>

            <div class="question-card" id="q11">
                <p class="question-text">[Q11] My father <span class="quiz-slot" data-ans="goes">_____</span> to work by bus.</p>
                <div class="options-grid">
            ...
            <div class="question-card" id="q12">
                <p class="question-text">[Q12] I <span class="quiz-slot" data-ans="eat">_____</span> breakfast in the morning.</p>
                <div class="options-grid">
